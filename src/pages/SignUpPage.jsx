...
import { UtensilsCrossed, Eye, EyeOff, Mail, Phone, User } from "lucide-react";
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div>
            <h1 className="text-4xl font-bold text-white mb-4 font-[family-name:var(--font-heading)]">
              Join Piki<span className="text-primary">Food</span> today
            </h1>
            <p className="text-white/60 text-lg">
              Order from hundreds of restaurants across Tanzania and Kenya. Fast
              delivery, secure M-Pesa payments, and real-time tracking.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-11 py-3 border border-gray-200 focus:border-primary focus:outline-none transition-colors duration-200 text-sm"
                />
                <button
                  type="button"
